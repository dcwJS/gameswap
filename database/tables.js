module.exports = {
	...
	offering: 'CREATE TABLE IF NOT EXISTS `Offering` (`id` INTEGER NOT NULL auto_increment, `gameid` INTEGER NULL DEFAULT NULL, `userid` INTEGER NULL DEFAULT NULL, `game_condition` MEDIUMTEXT NULL DEFAULT NULL, `platform` MEDIUMTEXT NULL DEFAULT NULL, `createdat` TIMESTAMP, PRIMARY KEY (`id`));',

	seeking: 'CREATE TABLE IF NOT EXISTS `Seeking` (`id` INTEGER NOT NULL auto_increment, `gameid` INTEGER NULL DEFAULT NULL, `userid` INTEGER NULL DEFAULT NULL, `platform` MEDIUMTEXT NULL DEFAULT NULL, `createdat` TIMESTAMP, PRIMARY KEY (`id`));',
